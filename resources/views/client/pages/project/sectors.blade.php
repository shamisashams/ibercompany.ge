    ...
    <section class="projects_page">
        <div class="wrapper pad48">
            <div class="sector_head flex dark-text">
                ...
                <a href="current-projects.html" class="font20 bold">View all</a>
            </div>
            <div class="project_grid">
                @foreach($currentProjects as $project)
                    <a href="single-project.html">
                        <div class="project_item">
                            <img class="bg" src="{{url(count($project->files)>0? $project->files[0]->path.'/'.$project->files[0]->title : 'noimage.png')}}" alt=""/>
            ...
            <div class="sector_head flex dark-text">
                ...
                <a href="finished-projects.html" class="font20 bold">@lang('client.view_all')</a>
            </div>
            <div class="project_grid">
