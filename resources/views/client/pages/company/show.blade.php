...
@section('wrapper')
    ...
    <section class="social_media companies">
        <div class="wrapper pad48 flex">
            <a href="#">
                <svg id="Icon_awesome-facebook-f" data-name="Icon awesome-facebook-f" xmlns="http://www.w3.org/2000/svg" width="9.238" height="17.248" viewBox="0 0 9.238 17.248">
                <path id="Icon_awesome-facebook-f-2" data-name="Icon awesome-facebook-f" d="M10.242,9.7l.479-3.121h-3V4.555a1.561,1.561,0,0,1,1.76-1.686h1.362V.211A16.606,16.606,0,0,0,8.43,0C5.964,0,4.351,1.5,4.351,4.2V6.58H1.609V9.7H4.351v7.546H7.726V9.7Z" transform="translate(-1.609)" fill="#231f20"/>
                </svg>
            </a>
            <a href="#">
                <svg id="Icon_ionic-logo-linkedin" data-name="Icon ionic-logo-linkedin" xmlns="http://www.w3.org/2000/svg" width="17.248" height="17.248" viewBox="0 0 17.248 17.248">
            ...
            <a href="#">
                <svg id="Icon_metro-instagram" data-name="Icon metro-instagram" xmlns="http://www.w3.org/2000/svg" width="16.414" height="16.413" viewBox="0 0 16.414 16.413">
            ...
            <a href="#">
                <svg id="Icon_awesome-twitter" data-name="Icon awesome-twitter" xmlns="http://www.w3.org/2000/svg" width="20.21" height="16.413" viewBox="0 0 20.21 16.413">
                <path id="Icon_awesome-twitter-2" data-name="Icon awesome-twitter" d="M18.132,7.471c.013.18.013.359.013.539A11.7,11.7,0,0,1,6.36,19.794,11.7,11.7,0,0,1,0,17.935a8.569,8.569,0,0,0,1,.051,8.3,8.3,0,0,0,5.142-1.77A4.149,4.149,0,0,1,2.27,13.344a5.223,5.223,0,0,0,.782.064,4.381,4.381,0,0,0,1.09-.141A4.142,4.142,0,0,1,.821,9.2V9.151a4.171,4.171,0,0,0,1.872.526,4.148,4.148,0,0,1-1.282-5.54,11.773,11.773,0,0,0,8.54,4.334,4.675,4.675,0,0,1-.1-.949,4.146,4.146,0,0,1,7.168-2.834,8.155,8.155,0,0,0,2.629-1,4.131,4.131,0,0,1-1.821,2.282,8.3,8.3,0,0,0,2.385-.641,8.9,8.9,0,0,1-2.077,2.141Z" transform="translate(0 -3.381)" fill="#231f20"/>
                </svg>

            </a>
            <a href="#">
                <svg id="Icon_awesome-pinterest-square" data-name="Icon awesome-pinterest-square" xmlns="http://www.w3.org/2000/svg" width="16.414" height="16.413" viewBox="0 0 16.414 16.413">
            ...
            <a href="#">
                <svg id="Icon_simple-youtube" data-name="Icon simple-youtube" xmlns="http://www.w3.org/2000/svg" width="23.486" height="16.414" viewBox="0 0 23.486 16.414">
